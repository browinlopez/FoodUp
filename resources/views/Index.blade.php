        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="#menu">Membresía</a></li>
                    <li><a href="#events">Roomhup</a></li>
                    <li><a href="#chefs">Cursos</a></li>
                    <li><a href="#gallery">Blog</a></li>
                    <li><a href="#Descarga">Descarga</a></a></li>
                    <li><a href="#contact">Contact</a></li>
                </ul>
            </nav><!-- .navbar -->

            <a class="btn-book-a-table" href="#book-a-table">Iniciar sesión</a>
            <a class="btn-book-a-table" href="#book-a-table">Registrate</a>
    ...
    <section id="hero" class="hero d-flex align-items-center section-bg">
        <div class="container">
            <div
                ...
                <p class="hero">Elevamos los sueños de pequeños y medianos empresarios que
                    junto a nuestros gestores desarrollan marcas con resultados exitosos.</p>
                <iframe width="1400" height="900"
                    src="https://www.youtube-nocookie.com/embed/pzRxqx6uXks?autoplay=1" title="YouTube video player"
                    frameborder="0"
    ...
    <main id="main">
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
                        <div class="content ps-0 ps-lg-5">
                            <p class="fst-italic">
                                Somos una comunidad de gestores que brindan soporte y desarrolla negocios en el sector
                                gastronómico a nivel nacional.Elevamos modelos de negocios con nuestros servicios,
                                acompañamiento práctico y herramientas que mejoran los procesos y disminuyen las áreas
                                de oportunidad en la cadena de sumistro, logrando negocios que operen de manera
                                eficiente, responsable y seguro. El foco de nuestra marca es el <b>conocimiento
                                    especializado</b>, por lo que podemos dar respuestas de manera eficiente y ágil.
                            </p>
        ...
        <section id="why-us" class="why-us section-bg">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h3>¡Ayudamos a llevar tu negocio de alimentos a otro nivel!</h3>
                    <br>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="why-box">
                                <br>
                                <br>
                                <h3>Grupo de gestores soporte técnico y desarrollo del negocio</h3>
                            </div>
                        </div><!-- End Why Box -->
                        <div class="col-xl-3" data-aos="fade-up" data-aos-delay="200">
                            <div class="why-box">
                                ...
                                <br>
                                <br>
                                <h3>Listado de proveedores industria de alimentos</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3" data-aos="fade-up" data-aos-delay="400">
                            <div class="why-box">
                                ...
                                <br>
                                <br>
                                <h3>Descarga de material gestión de inocuidad y calidad</h3>
                            </div>
                        </div><!-- End Icon Box -->
                ...
                <div>
                    ...
                    <a href="http://www.google.com" target="_parent"><button class="boton1">Compra</button></a>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style=" background-image: url(assets/img/FoodUp/fondoP.png);">
                        <h1>Pasos</h1>
                        <div class="row gy-4">
                            <div class="col-xl-3" data-aos="fade-up" data-aos-delay="100">
                                <img src="assets/img/FoodUp/uno.png"alt="Cargando imagen...">
                                    <h3>Contacta tu gestor</h3>
                                    <p>Contacta con tu gestor asignado para diagnosticar o necesidad puntual.</p>
                            </div>
                            
                            <div class="col-xl-3" data-aos="fade-up" data-aos-delay="200">
                                <img src="assets/img/FoodUp/dos.png"alt="Cargando imagen...">
                                <h3>Planeamos</h3>
                                <p>Food Up hace el plan de trabajo y te dice cuanto tarda en darte la solucion.</p>
                            </div>
                            
                            <div class="col-xl-3" data-aos="fade-up" data-aos-delay="300">
                            
                                <img src="assets/img/FoodUp/tres.png"alt="Cargando imagen...">
                                    <h3>Solucionamos</h3>
                                    <p>Te entregamos soluciones y respuestas tangibles en tiempos acordados.</p>
                            </div>
                            <div class="col-xl-3" data-aos="fade-up" data-aos-delay="400">
                                <img src="assets/img/FoodUp/cuatro.png"alt="Cargando imagen...">
                                    <h3>Reporte de gestion</h3>
                                    <p>Enviamos informes de gestion mensualmente.</p>
                            </div>
                        </div>
                    </div><!-- End Event item -->
